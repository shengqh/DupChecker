...
\begin{center}
    \begin{tabular}{ | l | }
      ...
      \\
      DupChecker: a bioconductor package for checking high-throughput genomic \\
      data redundancy in meta-analysis, Quanhu Sheng, Yu Shyr, Xi Chen, \\
      BMC bioinformatics 15 (1), 323 \\
      \hline 
    \end{tabular}
  \end{center}
\end{abstract}
